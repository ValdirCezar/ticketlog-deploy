...
public class EstadoService {
	...
	public List<EstadoDTO> findAllFromDTO(Double usd) throws ObjectNotFoundException {
	...
	public Estado findById(Integer id) throws ObjectNotFoundException {
	...
	private List<Cidade> listarCidades(Integer idEstado, Double usd) throws ObjectNotFoundException {
